...
namespace Memory
{
    public class Memory
    {
        ...
        private static extern void GetSystemInfo(out Memory.SYSTEM_INFO lpSystemInfo);
        [DllImport("kernel32.dll")]
        public static extern IntPtr OpenProcess(uint dwDesiredAccess, bool bInheritHandle, int dwProcessId);
        [DllImport("kernel32")]
        public static extern bool IsWow64Process(IntPtr hProcess, out bool lpSystemInfo);
        [DllImport("kernel32.dll")]
        private static extern bool VirtualProtectEx(IntPtr hProcess, UIntPtr lpAddress, IntPtr dwSize, Memory.MemoryProtection flNewProtect, out Memory.MemoryProtection lpflOldProtect);
        [DllImport("kernel32.dll")]
        ...
        public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Memory.MEMORY_BASIC_INFORMATION64 lpBuffer, UIntPtr dwLength);
        [DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx")]
        public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Memory.MEMORY_BASIC_INFORMATION32 lpBuffer, UIntPtr dwLength);
        ...
        public string LoadCode(string name, string file)
        {
            ...
            if (flag)
            {
                uint privateProfileString = Memory.GetPrivateProfileString("codes", name, "", stringBuilder, (uint)stringBuilder.Capacity, file);
            }
            else
            {
        ...
        public Task<IEnumerable<long>> AoBScan(long start, long end, string search, bool readable, bool writable, bool executable, string file = "")
        {
            return Task.Run<IEnumerable<long>>(delegate ()
            {
                ...
                Memory.SYSTEM_INFO system_INFO = default(Memory.SYSTEM_INFO);
                Memory.GetSystemInfo(out system_INFO);
                ...
                Memory.MEMORY_BASIC_INFORMATION memory_BASIC_INFORMATION = default(Memory.MEMORY_BASIC_INFORMATION);
        ...
        public void CloseProcess()
        {
            ...
            if (!flag)
            {
                Memory.CloseHandle(this.pHandle);
                this.theProc = null;
            }
        }
        ...
        private unsafe long[] CompareScan(MemoryRegionResult item, byte[] aobPattern, byte[] mask)
        {
            ...
            ulong num;
            Memory.ReadProcessMemory(this.pHandle, item.CurrentBaseAddress, intPtr, (UIntPtr)((ulong)item.RegionSize), out num);
        ...
        public UIntPtr VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out Memory.MEMORY_BASIC_INFORMATION lpBuffer)
        {
            bool flag = this.Is64Bit || IntPtr.Size == 8;
            UIntPtr result;
            if (flag)
            {
                Memory.MEMORY_BASIC_INFORMATION64 memory_BASIC_INFORMATION = default(Memory.MEMORY_BASIC_INFORMATION64);
                UIntPtr uintPtr = Memory.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION)));
            ...
            {
                Memory.MEMORY_BASIC_INFORMATION32 memory_BASIC_INFORMATION2 = default(Memory.MEMORY_BASIC_INFORMATION32);
                UIntPtr uintPtr = Memory.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION2, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION2)));
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (flag6)
                    {
                        ...
                        if (flag9)
                        {
                            Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)this.mainModule.BaseAddress + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                        }
                        else
                        {
                            ...
                            if (flag10)
                            {
                                ...
                                Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)value + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                            else
                            {
                                Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)array4[0]), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                        }
                        ...
                        for (int j = 1; j < array4.Length; j++)
                        {
                            ...
                            Memory.ReadProcessMemory(this.pHandle, uintPtr, array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (flag7)
                        {
                            ...
                            if (flag10)
                            {
                                Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)this.mainModule.BaseAddress + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                            }
                            else
                            {
                                ...
                                if (flag11)
                                {
                                    ...
                                    Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)value + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                                }
                                else
                                {
                                    Memory.ReadProcessMemory(this.pHandle, (UIntPtr)((ulong)((long)array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
                                }
                            }
        ...
        public bool WriteMemory(string code, string type, string write, string file = "", Encoding stringEncoding = null)
        {
            ...
            return Memory.WriteProcessMemory(this.pHandle, code2, array, (UIntPtr)((ulong)((long)num)), IntPtr.Zero);
        }
        public bool IsAdmin()
        {
            bool result;
        ...
        public bool OpenProcess(int pid)
        {
            ...
            if (flag)
            {
                Debug.WriteLine("executa sempre como adm men");
                notify("executa sempre como adm men");
            }
            bool flag2 = pid <= 0;
            bool result;
            if (flag2)
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            this.pHandle = Memory.OpenProcess(2035711U, true, pid);
                            ...
                            else
                            {
                                ...
                                this.GetModules();
                                bool flag6;
                                this.Is64Bit = (Environment.Is64BitOperatingSystem && Memory.IsWow64Process(this.pHandle, out flag6) && !flag6);
        ...
        public bool ChangeProtection(string code, Memory.MemoryProtection newProtection, out Memory.MemoryProtection oldProtection, string file = "")
        {
            UIntPtr code2 = this.GetCode(code, file, 8);
            ...
            if (flag)
            {
                oldProtection = (Memory.MemoryProtection)0U;
                result = false;
            }
            else
            {
                result = Memory.VirtualProtectEx(this.pHandle, code2, (IntPtr)(this.Is64Bit ? 8 : 4), newProtection, out oldProtection);
            }
            return result;
        }
        public byte[] AhReadMeFucker(string code, long length, string file = "")
        {
            ...
            UIntPtr code2 = this.GetCode(code, file, 8);
            bool flag = !Memory.ReadProcessMemory(this.pHandle, code2, array, (UIntPtr)(checked((ulong)length)), IntPtr.Zero);
            byte[] result;
            if (flag)
            {
                result = null;
